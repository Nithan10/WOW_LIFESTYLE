  ...
  return (
    ...
    >
        ...
        {status === 'idle' && (
          ...
          >
            ...
            <motion.img
              ...
              className="w-[280px] md:w-[350px] object-contain transition-all duration-500"
            />

            {/* 2. HOVER TEXT (Appears over image) */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <motion.span 
                className="text-[#D4AF37] text-xl md:text-2xl font-black tracking-[0.2em] uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-300 drop-shadow-md bg-black/50 px-4 py-2 rounded-lg backdrop-blur-sm border border-[#D4AF37]/30"
              >
                Click to Start
              </motion.span>
            </div>
      ...
      <motion.div
        ...
        animate={status === 'driving' ? { x: "150vw" } : { x: "-100vw" }} // Zoom to off-screen right
        transition={{ 
      ...
      >
        ...
        <img 
          src="/pngcar.png" 
          alt="Race Car" 
          className="w-[600px] md:w-[900px] max-w-none h-auto drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
        />
        
        {/* Speed lines/Motion Blur trail */}
        <div className="absolute top-1/2 right-0 w-[600px] h-[200px] bg-gradient-to-r from-transparent via-[#D4AF37]/20 to-transparent blur-3xl transform -translate-y-1/2 -skew-x-12" />
      </motion.div>
